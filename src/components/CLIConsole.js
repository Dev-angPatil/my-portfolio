      ...
      switch (trimmedCmd.toLowerCase()) {
        ...
        case "projects":
          newHistory.push(
            ...
            { type: "output", text: "2. ZERO-TO-BRAND (Solarpunk Campaign Engine)" },
            { type: "output", text: "   └ Stack: Next.js, Tailwind CSS, Gemini 2.5 Flash, Imagen 3.0, Web Audio API" },
            { type: "output", text: "   └ Desc: Autonomous design co-pilot creating storefronts and sonic branding." },
